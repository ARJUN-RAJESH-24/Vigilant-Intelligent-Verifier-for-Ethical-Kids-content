...
def generate_tfidf_features(df):
    """
    Generates TF-IDF features from cleaned captions and saves them to CSV.
    The vectorizer object is also saved for production use.
    """
    if len(df) == 0:
...
def main():
    ...
    # Extract structural and sentiment features
    features_list = []
    ...
    # Create structural features DataFrame
